...
function guvenli(kisiID) {
  ...
  if (!uye || uye.id === client.user.id || uye.id === ayarlar.owner || uye.id === ayarlar.whitelist || uye.id === ayarlar.kurucu || uye.id === ayarlar.admin || uye.id === ayarlar.yardımcı || uye.id === ayarlar.bot || uye.id === ayarlar.mod || uye.id === uye.guild.owner.id || guvenliler.some(g => uye.id === g.slice(1) || uye.roles.cache.has(g.slice(1)))) return true
  else return false;
};
